          ...
          <TouchableWithoutFeedback>
            ...
            >
              ...
              >
                ...
                {/* 大区 */}
                <View style={styles.section}>
                  <Text style={styles.sectionTitle}>大区</Text>
                  <View style={styles.optionsRow}>
                    {['QQ区', '微信区'].map((area) => (
                      <TouchableOpacity
                        key={area}
                        style={[
                          styles.chip,
                          filters.area.includes(area) && styles.chipSelected,
                        ]}
                        onPress={() =>
                          setFilters({
                            ...filters,
                            area: toggleArrayItem(filters.area, area),
                          })
                        }
                      >
                        <Text
                          style={[
                            styles.chipText,
                            filters.area.includes(area) && styles.chipTextSelected,
                          ]}
                        >
                          {area}
                        </Text>
                ...
                {/* 段位 */}
                <View style={styles.section}>
                  <Text style={styles.sectionTitle}>段位</Text>
                  <View style={styles.optionsRow}>
                    {['荣耀铂金', '永恒钻石', '至尊星耀', '最强王者', '荣耀王者'].map((rank) => (
                      <TouchableOpacity
                        key={rank}
                        style={[
                          styles.chip,
                          filters.rank.includes(rank) && styles.chipSelected,
                        ]}
                        onPress={() =>
                          setFilters({
                            ...filters,
                            rank: toggleArrayItem(filters.rank, rank),
                          })
                        }
                      >
                        <Text
                          style={[
                            styles.chipText,
                            filters.rank.includes(rank) && styles.chipTextSelected,
                          ]}
                        >
                          {rank}
                        </Text>
                ...
                <View style={styles.section}>
                  ...
                  <View style={styles.optionsRow}>
                    {['打野', '上路', '中路', '下路', '辅助', '全能'].map((position) => (
                      <TouchableOpacity
                        key={position}
                        style={[
                          styles.chip,
                          filters.position.includes(position) && styles.chipSelected,
                        ]}
                        onPress={() =>
                          setFilters({
                            ...filters,
                            position: toggleArrayItem(filters.position, position),
                          })
                        }
                      >
                        <Text
                          style={[
                            styles.chipText,
                            filters.position.includes(position) && styles.chipTextSelected,
                          ]}
                        >
                          {position}
                        </Text>
                ...
                <View style={styles.section}>
                  ...
                  <View style={styles.optionsRow}>
                    {['荣耀王者', '大神认证', '巅峰赛', '带粉上分', '官方认证', '声优陪玩'].map((tag) => (
                      <TouchableOpacity
                        key={tag}
                        style={[
                          styles.chip,
